...
INSERT INTO TransportVille(id_transport, type_billet,  prix, place_achat_billet, informations, ref_voyage)
VALUES
  (1, '1 semaine', 30, 'online', 'Ticket pour zoons 1-5 sans aeroprt',4);

CREATE TABLE TicketActivite(
...
INSERT TicketActivite(id_ticket, nom, prix, place_achat_billet, ref_activite)
VALUES
	(1, 'Ticket jeune 18-26', 18, 'online', 1);

CREATE TABLE ItemChecklistAvantDepart( -- one iteam
...
INSERT ItemChecklistAvantDepart(id_checklist, description_tache, est_fait, ref_voyage)
VALUES
